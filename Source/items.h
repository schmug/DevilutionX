...
// Forward declaration of the DropRateContext enum class from drop_rate_config.h
...
void CreateTypeItem(Point position, bool onlygood, ItemType itemType, int imisc, bool sendmsg, bool delta, bool spawn = false, DropRateContext dropContext = static_cast<DropRateContext>(2)); // 2 = GroundDrop
