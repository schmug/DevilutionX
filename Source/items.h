...
void CreateTypeItem(Point position, bool onlygood, ItemType itemType, int imisc, bool sendmsg, bool delta, bool spawn = false, DropRateContext dropContext = DropRateContext::GroundDrop);
